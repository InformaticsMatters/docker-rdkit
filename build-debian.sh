...
# build RDKit
docker build --no-cache -f Dockerfile-build-debian\
...
docker build --no-cache -f Dockerfile-python-debian\
...
docker build --no-cache -f Dockerfile-java-debian\
...
docker build --no-cache -f Dockerfile-tomcat-debian\
...
docker build --no-cache -f Dockerfile-cartridge-debian\
